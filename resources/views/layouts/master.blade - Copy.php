...
<img src="http://localhost/howdy/images/首1.png" background-size="cover" width="100%;" height="20%"></img>
		...
		@else
			<div class="col-md-3 column">
		<!--<button type="button" style="background: url(http://localhost/howdy/images/首2.png); background-repeat:no-repeat; background-size: 100% 100%" class="btn btn-lg btn-block" onClick="document.location.href='./login'"></button>-->
				 <button type="button" class="btn btn-lg btn-block" style="background: url(http://localhost/howdy/images/首2.png); background-repeat:no-repeat; background-size:100% 100%;" onClick="document.location.href='./login'"><br></button>
			</div>
		@endif
