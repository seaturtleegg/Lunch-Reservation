...
<div class="col-md-3 hidden-xs" >
	...
	<div class="col-md-12 col-xs-12 column" style="font-size:1.5em; color:FFFFFF;text-align:center; float:left;">
		...
		<?php 
			...
			<br><?php echo "Hi " ?><?php echo e(Auth::user()->username); ?><br>
		</div>
			<div id="balance">
...
<div class="col-md-9 col-xs-12 column">
	...
	<div class="col-md-12" style="margin-top: 5px;">
		...
		<div class= "table-responsive">
			...
			<?php } ?>
			   ...
			   <form class="form-horizontal" role="form" method="post" action="order">
			    ...
			    <table border="0" width="98%"  height="145" cellpadding="0" cellspacing="0" style="margin: 5px;">
                 <tr>
                  <td width="40%" rowspan="4"><img src="images/<?php echo e($food->imageurl); ?>" width="90%" height="130" style="float:right;"/></td> 
                   <td width="60%" style="font-size:18px;"><strong>&nbsp;<?php echo e($food->name); ?></strong></td>
                 </tr>
				 <tr>
                   <td style="font-size:18px;">&nbsp;<?php echo e($food->englishname); ?></td>
                 </tr>
                 <tr>
                   <td style="font-size:20px;">&nbsp;Price: <font color="#FF0000"><?php echo e($food->price); ?></font></td>
                 </tr>
                 <tr>
                   <td style="font-size:20px;">&nbsp;<input type = 'submit' style="color:#000000;" value='Choose' name='order'>
						
				   </td>
                 </tr><tr></tr>  <input type="hidden" name="order" id="order" value="<?php echo e($food->id); ?>">
                </table></form>
			   </td>
			   <?php 
			     if($count%4==0){
		  ...
		  <div class="col-md-7 col-md-offset-5"><?php echo e($foods->links()); ?></div>
		</div>
